  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        Text(AppLocale.your_regular_physical_activity_level.tr(),style: Theme.of(context).textTheme.headlineLarge,),
        SizedBox(height: height * AppSize.s0_05,),
          ...
          child: Column(
            ...
            children: [
              GroupButton( 
                ...
                isRadio: true,
                controller: widget.registerCubit.rpalController,
                ...
                onSelected: (value, index, isSelected) 
                {
                  ...
                  if(index == 0){
                    widget.registerCubit.physicalActivityLevel = 'level1';
                    widget.registerCubit.rpalController.selectIndex(0);
                  }else if(index == 1){
                    widget.registerCubit.physicalActivityLevel = 'level2';
                    widget.registerCubit.rpalController.selectIndex(1);
                  }else if(index == 2){
                    widget.registerCubit.physicalActivityLevel = 'level3';
                    widget.registerCubit.rpalController.selectIndex(2);
                  }else if(index == 3){
                    widget.registerCubit.physicalActivityLevel = 'level4';
                    widget.registerCubit.rpalController.selectIndex(3);
                  }else if(index == 4){
                    widget.registerCubit.physicalActivityLevel = 'level5';
                    widget.registerCubit.rpalController.selectIndex(4);
                  }
                  setState(() {
                ...
                buttons: [
                  AppLocale.rookie.tr(),
                  AppLocale.beginner.tr(),
                  AppLocale.intermediate.tr(),
                  AppLocale.advance.tr(),
                  AppLocale.true_beast.tr()
                ],
              ),
              SizedBox(height: height * AppSize.s0_05,),
              Container(
                  ...
                  width: double.infinity,
                  child: Visibility(
                    visible: widget.registerCubit.physicalActivityLevel == null? false:true ,
