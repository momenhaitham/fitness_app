...
void main() {
  ...
  // قراءة ملف Routes
  final routesFile = File('lib/core/routes/app_route.dart');
  ...
  // كتابة الملف
  final outputFile = File('lib/core/routes/route_generator.dart');
...
String _generateImportPath(String fieldName) {
  ...
  return 'package:fitness_app/feature/$snakeCase/presentation/views/${snakeCase}_screen.dart';
}
...
String _generateRouteGenerator(Map<String, RouteInfo> routes) {
  ...
  // Imports
  buffer.writeln("import 'package:fitness_app/core/routes/app_route.dart';");
